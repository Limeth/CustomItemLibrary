...
public class SortedList<T> extends LinkedList<T> {
    ...
    public static <T> SortedList<T> create() {
        return new SortedList<>();
    }

    public static <T> SortedList<T> create(Comparator<? super T> comparator) {
    ...
    private static void apologise() {
        throw new NotImplementedException("Cannot use this method on a sorted list.");
    }
